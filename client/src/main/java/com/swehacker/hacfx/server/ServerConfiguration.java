...
public abstract class ServerConfiguration {
    ...
    private static final String DESKTOPFX_SERVER_ADDRESS =  System.getProperty("hacfx.server.address", "localhost");
    private static final String DESKTOPFX_SERVER_PORT =     System.getProperty("hacfx.server.port", "8080");
